namespace AoC_2017_Day_23
{
    ...
    internal class Duet
    {
        ...
        public Duet(string[] instructionSet, int initValue = 0)
        {
        ...
        State Dispatcher()
        {
            ...
            switch (cmds[0])
            {
                ...
                case "jgz":
                    ...
                    if (!_registers.TryGetValue(cmds[1], out long jgzValue))
                    {
                        if (!long.TryParse(cmds[1], out jgzValue)) throw new Exception("Unable to parse");
                    }
                ...
                case "jnz":
                    ...
                    if (!_registers.TryGetValue(cmds[1], out long jnzValue))
                    {
                        if (!long.TryParse(cmds[1], out jnzValue)) throw new Exception("Unable to parse");
                    }
        ...
        public long NumTimesMulInvoked() => _part1Answer;

        public long RegisterValue(string name)
        {
