namespace AoC_2019_IntcodeVM
{
    ...
    internal class IntcodeVM
    {
        ...
        private readonly Queue<int> _inputBuffer = new ();
        private readonly Queue<int> _outputBuffer = new();
        ...
        private State Dispatcher(int opCode) 
        {
            ...
            switch (instruction)
            {
                ...
                case 3: // Opcode 3 takes a single integer as input and saves it to the position given by its only parameter.
                    ...
                    break;
                case 4: //output
                    _outputBuffer.Enqueue(Ptr_ReadValue(modeFirst));
                    break;
        ...
        public bool GetOutput(out int? output)
        {
            output = null;
        ...
        private void Mem_Write(int address, int value) => _mainMemory[address] = value;
        private int Mem_Read(int address) => _mainMemory[address];
