...
namespace AoC_AStar
{
    ...
    internal static class AStar
    {
        ...
        public static bool A_Star(Point start, Point dest, Dictionary<Point, MapSymbols> theMap, out int numSteps, out List<Point> finalPath, int? maxSteps = null)
        {
            finalPath = new();
            ...
            bool TestStep(Point cursor, Point nextPoint)
            {
                ...
                if (theMap.TryGetValue(nextPoint, out MapSymbols value))
                {
